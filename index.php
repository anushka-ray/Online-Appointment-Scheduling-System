...
$res = mysqli_query($con,"SELECT * FROM patient WHERE Aadhar = '$Aadhar'");
$row=mysqli_fetch_array($res,MYSQLI_ASSOC);
if ($row['password'] == $password)
{
$_SESSION['patientSession'] = $row['Aadhar'];
?>
...
//INSERT
$query = " INSERT INTO patient (  Aadhar, password, patientFirstName, patientLastName,  patientDOB, patientGender,  phone, patientEmail )
VALUES ( '$Aadhar', '$password', '$patientFirstName', '$patientLastName', '$patientDOB', '$patientGender','$phone', '$patientEmail' ) ";
...
<html lang="en">
    ...
    <body>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    <label class="sr-only" for="Aadhar">Email</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="text" name="Aadhar" value="" class="form-control input-lg" placeholder="Aadhar Number"  required/>
        ...
        <img alt="Brand" src="assets/img/howto.png" height="540px"></a>
        </section>
        <!-- forth section end -->
        <!-- footer start -->
