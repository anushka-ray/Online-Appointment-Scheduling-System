...
$res=mysqli_query($con, "SELECT a.*, b.*,c.* FROM patient a
	...
	$usname=mysqli_query($con,"SELECT * FROM patient WHERE Aadhar=".$session);
	$userRow2=mysqli_fetch_array($usname,MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html>
	<head>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $userRow2['patientFirstName']; ?> <?php echo $userRow2['patientLastName']; ?><b class="caret"></b></a>
							<ul class="dropdown-menu">
								<li>
									<a href="profile.php?patientId=<?php echo $userRow2['Aadhar']; ?>"><i class="fa fa-fw fa-user"></i> Profile</a>
								</li>
								<li class="divider"></li>
								<li>
