...
// on b.Aadhar = a.Aadhar
$res = mysqli_query($con,"SELECT a.*, b.* FROM doctorschedule a INNER JOIN patient b
WHERE a.scheduleDate='$appdate' AND scheduleId=$appid AND b.Aadhar=$session");
...
$patientIc = mysqli_real_escape_string($con,$userRow['Aadhar']);
$scheduleid = mysqli_real_escape_string($con,$appid);
$symptom = mysqli_real_escape_string($con,$_POST['symptom']);
$avail = "notavail";


$query = "INSERT INTO appointment (  patientIc , scheduleId , appSymptom  )
VALUES ( '$patientIc', '$scheduleid', '$symptom') ";
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<ul class="nav navbar-nav">
							...
							<!-- <li><a href="profile.php?patientId=<?php echo $userRow['Aadhar']; ?>" >Profile</a></li> -->
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li>
									<a href="patientapplist.php?patientId=<?php echo $userRow['Aadhar']; ?>"><i class="glyphicon glyphicon-file"></i> Appointment</a>
								</li>
								<li class="divider"></li>
								<li>
										...
										<form class="form" role="form" method="POST" accept-charset="UTF-8">
											<div class="panel panel-default">
												...
												<div class="panel-body">
													...
													Patient Aadhar: <?php echo $userRow['Aadhar'] ?><br>
