...
$res=mysqli_query($con,"SELECT * FROM patient WHERE Aadhar=".$_SESSION['patientSession']);
...
$res=mysqli_query($con,"UPDATE patient SET patientFirstName='$patientFirstName', patientLastName='$patientLastName', patientDOB='$patientDOB', patientGender='$patientGender', patientAddress='$patientAddress', phone=$phone, patientEmail='$patientEmail' WHERE Aadhar=".$_SESSION['patientSession']);
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<ul class="nav navbar-nav">
							...
							<li><a href="patientapplist.php?patientId=<?php echo $userRow['Aadhar']; ?>">Appointment</a></li>
						</ul>
					</ul>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li>
									<a href="profile.php?patientId=<?php echo $userRow['Aadhar']; ?>"><i class="fa fa-fw fa-user"></i> Profile</a>
								</li>
								<li class="divider"></li>
								<li>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										...
										<table class="table table-user-information" align="center">
											...
											<tr>
													<td>Patient Name</td>
													<td><?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?></td>
												</tr>							
												<tr>
													<td>PatientDOB</td>
