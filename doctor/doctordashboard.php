                    ...
                    <div class="panel panel-primary filterable">
                       ...
                       <div class="panel-heading">
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="Patient First Name" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Patient Last Name" disabled></th>
